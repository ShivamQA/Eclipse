...
public class loginPageActions extends GetPage {
	...
	public void verifyRememberMeCheckBox() {
		...
		Assert.assertTrue(isElementDisplayed(true, "checkbox_rememberMe"), "Assertion Failed: Remember Me Checkbox not present");
		logMessage("Verified: RememberMe Checkbox is present");
		Assert.assertTrue(element("checkbox_rememberMe").isSelected(),
				"Assertion Failed: Remember Me Checkbox is not Checked");
		logMessage("Verified: Remember Me Checkbox is Checked");
