...
AuthorPopup_Affiliations     0  		xpath				//*[@class="loa"]/li[${index}]//div[contains(@class,"affiliations")]//li
AuthorPopup_MoreBy			 0			xpath				//*[@class="loa"]/li[${index}]//div[contains(@class,"scifinder")]/span[text()="More by "]/a
...
txt_referenceSection         0          xpath               (//div[@class="refs-header-label"]//h2[text()='References'])[1] | //h2[text()='References']
...
block_ack                    0          query                .refs-header-label h2
link_RightsPermissions		 0			css					.articleRightsPermissionsLink>a
block_CiteBy                 0          css                 #citeThis
list_citeByContent           0          xpath                 (//ol[@class="cited-content_cbyCitation"]/li)[1]
txt_noCiteByContent          0          css                 #citing ~p   
doi_articles                 0          css                 .issue-item_title a              